...
<form action="editDo.php" method="post">
    ...
    <table width="444" border="1" cellpadding="0" cellspacing="0" align="center">
       ...
       <tr>
        ...
        <tr>
        <td>ACOUNT NO</td>
        <td> <input type="text" name="acountno" size="100%" value=<?php echo $user['acountno'] ?> /></td>
       </tr>
        <tr>
        <td>ACOUNT TYPE</td>
        <td> <input type="text" name="acounttype" size="100%" value=<?php echo $user['acounttype'] ?> /></td>
       </tr>
